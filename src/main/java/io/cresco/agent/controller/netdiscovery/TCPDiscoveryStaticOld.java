...
public class TCPDiscoveryStaticOld {
    ...
    public TCPDiscoveryStaticOld(ControllerEngine controllerEngine) {
        this.controllerEngine = controllerEngine;
        this.plugin = controllerEngine.getPluginBuilder();
        this.logger = plugin.getLogger(TCPDiscoveryStaticOld.class.getName(),CLogger.Level.Info);
    ...
    public TCPDiscoveryStaticOld(ControllerEngine controllerEngine, int discoveryPort) {
        this.controllerEngine = controllerEngine;
        this.plugin = controllerEngine.getPluginBuilder();
        this.logger = plugin.getLogger(TCPDiscoveryStaticOld.class.getName(),CLogger.Level.Info);
